    ...
    <el-container>
      <el-aside width="200px">
        <el-menu :default-active="activeIndex">
          <el-menu-item :index="category.id" v-for="category in categories" :key="category.id" :value="category.id"
            @click="filterByCategory(category.id)" :class="{ 'is-active': activeIndex === category.id }">
            {{ category.name }}
          </el-menu-item>
        </el-menu>
      </el-aside>
